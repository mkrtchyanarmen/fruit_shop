...
/**
 * Splits total transport across lines: proportional to (quantity × unitCost),
 * falling back to quantity-only weights when value weights are all zero, then
 * equal split among lines with quantity > 0.
 */
