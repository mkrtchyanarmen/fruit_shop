...
export interface ApiFruitFruit extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A fruit catalog item sold across shops.';
    displayName: 'Fruit';
    pluralName: 'fruits';
    singularName: 'fruit';
  };
  ...
  attributes: {
    ...
    >;
    stockArrivals: Schema.Attribute.Relation<
      'oneToMany',
      'api::stock-arrival.stock-arrival'
    >;
    unit: Schema.Attribute.Enumeration<['kg', 'piece', 'bunch']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSaleItemSaleItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A sale of fruit at a shop, with quantity and selling price.';
  ...
  attributes: {
    ...
    fruit: Schema.Attribute.Relation<'manyToOne', 'api::fruit.fruit'> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    pricePerUnit: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiShopShop extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A physical fruit shop location.';
    displayName: 'Shop';
    pluralName: 'shops';
    singularName: 'shop';
  };
...
export interface ApiStockArrivalStockArrival
  extends Struct.CollectionTypeSchema {
  collectionName: 'stock_arrivals';
  info: {
    description: 'A delivery of fruit to a shop, with quantity and costs.';
    displayName: 'StockArrival';
    pluralName: 'stock-arrivals';
    singularName: 'stock-arrival';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    shop: Schema.Attribute.Relation<'manyToOne', 'api::shop.shop'> &
      Schema.Attribute.Required;
    transportCost: Schema.Attribute.Decimal & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::stock-arrival.stock-arrival': ApiStockArrivalStockArrival;
